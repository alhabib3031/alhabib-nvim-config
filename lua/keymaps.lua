...
keymap('n', '<C-A-l>', function() require('conform').format { async = true, lsp_format = 'fallback' } end, { desc = 'Format buffer' })
keymap('', '<leader>f', function() require('conform').format { async = true, lsp_format = 'fallback' } end, { desc = '[F]ormat buffer' })
...
keymap('n', '<leader>dr', function() require('dap').restart() end, { desc = 'Debug: Restart' })
...
-- INLAY HINTS TOGGLE
-- ─────────────────────────────────────────────────────────────
keymap('n', '<leader>ti', function() vim.lsp.inlay_hint.enable(not vim.lsp.inlay_hint.is_enabled {}) end, { desc = '[T]oggle [I]nlay Hints' })
