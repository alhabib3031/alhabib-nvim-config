...
return {
	...
	-- Razor syntax highlighting (تلوين الكود في ملفات .razor و .cshtml)
	{
		"jlcrochet/vim-razor",
		ft = { "razor", "cshtml" },
	},
	...
	-- ─────────────────────────────────────────────────────────────
	{
		...
		config = function()
			...
			-- ── UI Setup ──────────────────────────────────────────────
			-- suppress Lua LSP warnings for dapui — the type annotations are outdated
			...
			-- Auto open/close UI
			-- (dap.listeners fields are dynamically indexed — suppress Lua LSP warnings)
